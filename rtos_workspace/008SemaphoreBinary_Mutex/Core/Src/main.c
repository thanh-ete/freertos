...
TaskHandle_t HighPT_Handler;
TaskHandle_t MediumPT_Handler;
TaskHandle_t LowPT_Handler;
...
int main(void)
{
  ...
  xTaskCreate(Low_Task, "LPT",128, NULL, 1, &LowPT_Handler);
  vTaskStartScheduler();
...
void High_Task (void *argument)
{
	uint8_t *strtosend = "In High Priority...........................\n";
	while (1)
	{
		char *str = "Entered Hight_PT and About to take Semaphore\n";
		HAL_UART_Transmit(&huart2, str, strlen (str), HAL_MAX_DELAY);
...
void Low_Task (void *argument)
{
	uint8_t *strtosend = "In Low Priority...........................\n";
	while (1)
	{
		char *str = "Entered Low_PT and About to take Semaphore\n";
		HAL_UART_Transmit(&huart2, str, strlen (str), HAL_MAX_DELAY);

		send_UART(strtosend);

		char *str2 = "Leaving Low_PT\n\n";
		HAL_UART_Transmit(&huart2, str2, strlen (str2), HAL_MAX_DELAY);
